...
// --- EMERGENCY CRITICAL AUTO-INSTALLER ---
// This runs BEFORE any other libraries are loaded to guarantee pdf-lib exists on Render
try {
...
// --- SECURE LIFECYCLE WRAPPER ---
// Using dynamic imports ensures Node doesn't look for pdf-lib until AFTER the installer runs
...
// Fire execution
bootstrapServer().catch(err => console.error("Critical server boot failure:", err));
